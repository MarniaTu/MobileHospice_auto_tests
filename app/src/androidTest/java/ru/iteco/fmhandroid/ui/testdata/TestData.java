...
public class TestData {
    ...
    public static final String LOGIN_CORRECT = "login2";
    public static final String PASS_CORRECT = "password2";
    public static final String LOGIN_WRONG = "log2";
    public static final String NEW_NEWS_DESCRIPTION = "Best Wishes";
    public static final String ANOTHER_NEWS_DESCRIPTION = "Hello";
    ...
    public static final String TERMS_OF_USE_LINK_TEXT = "https://vhospice.org/#/terms-of-use";
}
